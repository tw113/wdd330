...
const hikeList = [
  {
    ...
    comments: [
      'This is a comment by someone who actually has time toi make comments on social media things',
    ],
  },
  {
    name: 'Teton Canyon',
...
localStorage.setItem('hikes', hikeList);
...
function renderOneHikeFull(hike) {
  ...
  item.innerHTML = ` 
        ...
        <h3>Comments:</h3>
        ${buildCommentList(hike.comments)}
        <br>
        <br>
        <br>
        <div id="add-comment">
...
function buildCommentList(commentList) {
  let commentHTML = '';
